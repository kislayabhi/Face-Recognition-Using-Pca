function c = knn(P, y, Q,  k)
	...
	%%
	%%	Args:
	%%		P [dim x num_data] projection vector(weights) for the training images.
	%%		Q [dim x 1] projection vector(weights) for the test image.
	%%		y [1 x num_data] classes corresponding to P. (y =
	%%		{1,2,...,n})...it tells us which folder a image projection
    %%         belongs to
